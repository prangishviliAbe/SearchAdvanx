# SearchAdvanx Releases

All releases of SearchAdvanx with detailed information, download links, and changelogs.
...
- **Manual Update Checks** - Check for updates on demand with immediate feedback
- **WordPress-Native Integration** - Seamless update notifications and installation process
...
- Current version display with update status
...
- **Update Process**: Automatic, settings-preserved updates
...
- Streamlined plugin architecture for stability
...
- **JetEngine Support** - Custom query type for dynamic content filtering
- **External Site Search** - Cross-site search functionality with caching
- **Admin Interface** - Comprehensive settings and management dashboard
- **Search Analytics** - Detailed search statistics and logging
...
- **Database**: Custom search logging tables
...
- **JetEngine**: All versions supported
...
- **📋 Issues**: https://github.com/prangishviliAbe/SearchAdvanx/issues
- **📚 Documentation**: See README.md and plugin admin interface
- **💬 Support**: GitHub Issues or plugin support forums

---

## 📜 License

SearchAdvanx is licensed under the GPL v2 or later.

- **License**: [GPL v2+](https://www.gnu.org/licenses/gpl-2.0.html)
- **Copyright**: © 2025 Abe Prangishvili
